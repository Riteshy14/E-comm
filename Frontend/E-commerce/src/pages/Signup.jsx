...
export function Signup() {
    ...
    return (
        <div className="h-screen flex flex-col">
            ...
            <section className="flex-1 dark:bg-gray-900  w-full flex items-center justify-center px-6 py-8 mx-auto lg:py-0">
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 text-sm">
                                    <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the 
                                        <a className="font-medium text-primary-600 hover:underline dark:text-primary-500 transition-all duration-200">Terms and Conditions</a>
                                    </label>
                                </div>
                            </div>
                            <button 
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                ...
                                <Link to={'/signin'} className="font-medium text-primary-600 hover:underline dark:text-primary-500 transition-all duration-200"> Login here</Link>
                            </p>
                        </form>
                    </div>
                </div>
